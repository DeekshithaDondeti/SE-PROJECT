...
p1 = "https://apis.mapmyindia.com/advancedmaps/v1/75509e0f-f849-4a0d-9f07-b57196878308/distance_matrix/driving/"
p11 = ""
p2 = "?sources="
p3 = "&destinations="
...
dis = []
startres = requests.get("https://apis.mapmyindia.com/advancedmaps/v1/75509e0f-f849-4a0d-9f07-b57196878308/distance_matrix/driving/"+startpoint+p11+"?rtype=0&region=ind")



response = requests.get(p1+p11+p2+p3, headers={'Authorization': '75509e0f-f849-4a0d-9f07-b57196878308'})
d = response.json()
print(d)
dismat = []
durmat = []
